...
docker run  --add-host zipkin:$ZIPKINIP --add-host stockmanager:$STOCKIP --publish  8080:8080 --publish  9080:9080 --rm  --volume $CONF:/$CONTAINER_DIR/conf --volume $CONFSECURE:/$CONTAINER_DIR/confsecure --name storefront  $REPO/storefront
